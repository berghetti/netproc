...
test_Byte_per_second_si( struct config_op *co )
{
  ...
  char *expected[] = {"0", "500 B/s", "1.00 KiB/s", "2.00 KiB/s", "4.88 KiB/s", "9.76 KiB/s", "10.00 MiB/s"};
  ...
  {
    TEST_ASSERT_TRUE ( human_readable ( buff, sizeof ( buff ), values[i], RATE ) );
    PRINT ( "%s\n", buff );
...
test_bit_per_second_si( struct config_op *co )
{
  ...
  char *expected[] = {"0", "1015 b/s", "1.00 Kib/s", "2.00 Kib/s", "5.86 Kib/s", "9.76 Kib/s", "10.00 Mib/s"};
...
test_bit_per_second_iec( struct config_op *co )
{
  ...
  char *expected[] = {"0", "999 b/s", "1.01 Kb/s", "1.02 Kb/s", "6.00 Kb/s", "10.00 Kb/s", "10.49 Mb/s"};
