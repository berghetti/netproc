...
usage ( void )
{
  ...
  fputs ( "Usage: " PROG_NAME " [options]\n"
         ...
         " -f, --file \"file\"       save statistics in file, file name is optional, default is '" PROG_NAME_LOG "'\n"
         " -h, --help              show this message\n"
         " -i, --interface iface   specifies an interface, default is all (except interface with network 127.0.0.0/8)\n"
         ...
         " --si                    show SI format, with powers of 1000, default is IEC, with powers of 1024\n"
